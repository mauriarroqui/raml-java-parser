 ...
 */
public class FieldPresentInContextRule extends Rule
{
    ...
    public FieldPresentInContextRule(String selector, Rule then)
    {
    ...
    {
        return NodeSelector.selectFromContext(selector, node) != null;
    }
